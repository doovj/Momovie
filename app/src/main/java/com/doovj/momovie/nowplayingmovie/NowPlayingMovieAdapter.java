...
public class NowPlayingMovieAdapter extends RecyclerView.Adapter<NowPlayingMovieAdapter.NowPlayingMovieHolder> {
    private ArrayList<MovieItems> mData = new ArrayList<>();
    private Context context;
    private LayoutInflater mInflater;
    private static final String URL_POSTER = "http://image.tmdb.org/t/p/w342";

    NowPlayingMovieAdapter(Context context) {
    ...
    @Override
    public NowPlayingMovieHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.cardview_movie, parent, false);
        return new NowPlayingMovieHolder(view);
    }

    @Override
    public void onBindViewHolder(NowPlayingMovieHolder holder, int position) {
    ...
    class NowPlayingMovieHolder extends RecyclerView.ViewHolder{
        ...
        NowPlayingMovieHolder(View itemView) {
            super(itemView);
